 ...
 *
 * @ViewsField("delete_department")
 */
class DeleteDepartment extends FieldPluginBase {
  ...
  public function render(ResultRow $values) {
    $result = [];
    $nid = $values->nid;
    if ($values->node__db_departments_db_departments_target_id) {
      $target_id = $values->node__db_departments_db_departments_target_id;

      $result['remove'] = [
        '#type' => 'link',
        '#title' => '',
        '#url' => Url::fromRoute('crm_department_balance.remove_department_balance', [
          'nid' => $nid,
          'target_id' => $target_id,
        ]),
        '#attributes' => [
