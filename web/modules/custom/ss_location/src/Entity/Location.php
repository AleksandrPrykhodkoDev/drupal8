 ...
 *   },
 *   base_table = "smallsteps_test_dashboard.Locations",
...
class Location extends ContentEntityBase {
  ...
  public function getMainBannerStatus1() {
    $value = $this->get('mainbannerstatus1')->value;
    if (!$value) {
      $value = gc('LocationMainBannerStatus1');
    }
    return $value;
  }

  public function getMainBannerStatus2() {
    $value = $this->get('mainbannerstatus2')->value;
    if (!$value) {
      $value = gc('LocationMainBannerStatus2');
    }
    return $value;
  }

  public function getMainBannerStatus3() {
    $value = $this->get('mainbannerstatus3')->value;
    if (!$value) {
      $value = gc('LocationMainBannerStatus3');
    }
    return $value;
  }

  public function getMainBannerURL1() {
    $value = $this->get('mainbannerurl1')->value;
    if (!$value) {
      $value = gc('LocationMainBannerURL1');
    }
    return $value;
  }

  public function getMainBannerURL2() {
    $value = $this->get('mainbannerurl2')->value;
    if (!$value) {
      $value = gc('LocationMainBannerURL2');
    }
    return $value;
  }

  public function getMainBannerURL3() {
    $value = $this->get('mainbannerurl3')->value;
    if (!$value) {
      $value = gc('LocationMainBannerURL3');
    }
    return $value;
  }
  ...
  public function getBranchServiceKDV() {
    return $this->get('branchservicekdv')->value;
  }

  public function getBranchServiceBSO() {
    return $this->get('branchservicebso')->value;
  }

  public function getBranchServiceTSO() {
    return $this->get('branchservicetso')->value;
  }

  public function getBranchServiceVSO() {
    return $this->get('branchservicevso')->value;
  }

  public function getBranchServicePSZ() {
    return $this->get('branchservicepsz')->value;
  }
