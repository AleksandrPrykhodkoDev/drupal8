...
class LocationCalculatorForm extends FormBase {
   ...
   * {@inheritdoc}
   */
  public function includeForm($location = NULL) {
	  	ob_start(); 
		include (__DIR__ . "../../../../../form-nettokosten/include.php");
		$calculator_content = ob_get_contents();
		ob_end_clean();
	/**
	 * Using Symfony I'd call the twig template something like this, please alter this to the appropriate Drupal code:
	 */
		return $this->render("themes/smallsteps/templates/ss_location/ss-location--calculator-page.html.twig", array("calculator_content" => $calculator_content));
  }
