  ...
  Drupal.behaviors.contactSection = {
    attach: function (context, settings) {
      if (settings.ss_location.contact) {
        ...
        if (settings.ss_location.contact.title) {
          var title = settings.ss_location.contact.title;
        }
        if (settings.ss_location.contact.page) {
          var page = settings.ss_location.contact.page;
        }
